    ...
    >
      ...
      <div className="max-w-7xl mx-auto mt-12 pt-8 border-t border-card-border/20 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <div className="flex gap-4">
          {/* Faux social icons */}
          <a href="#" className="text-muted-text/60 hover:text-primary-accent transition-colors" aria-label="Veylon Twitter/X">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
            </svg>
          </a>
          <a href="#" className="text-muted-text/60 hover:text-primary-accent transition-colors" aria-label="Veylon GitHub">
            <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
